document.addEventListener("DOMContentLoaded", () => {
    ...
    function aplicarEstadoActividad(inicial, btnInicio, statusElement, btnPausa = null) {
      const estadoHorario = verificarHorarioPermitido(inicial);
      ...
      if (estadoHorario.estado === "temprano") {
        ...
        if (btnPausa) btnPausa.disabled = true; // Se activa luego de iniciar
      }
    }
    
    // Aplicar lógica a los botones de COMIDA, BREAK, CAP/RETRO Y PAUSA
  
    // COMIDA
    const btnInicioC = document.querySelector('tr[data-inicial="C"] .btn-inicio');
    const btnPausaC = document.querySelector('tr[data-inicial="C"] .btn-pausa');
    const statusC = document.getElementById("C-status");
    const timerC = document.getElementById("C-timer");
  
    btnInicioC.addEventListener("click", () => {
      aplicarEstadoActividad("C", btnInicioC, statusC, btnPausaC)
    });
  
    btnPausaC.addEventListener("click", () => {
      // Tu lógica para pausar la actividad "COMIDA"
    });
  
  
    // BREAK
    const btnInicioB = document.querySelector('tr[data-inicial="B"] .btn-inicio');
    const btnPausaB = document.querySelector('tr[data-inicial="B"] .btn-pausa');
    const statusB = document.getElementById("B-status");
    const timerB = document.getElementById("B-timer");
  
    btnInicioB.addEventListener("click", () => {
      aplicarEstadoActividad("B", btnInicioB, statusB, btnPausaB)
    });
  
    btnPausaB.addEventListener("click", () => {
      
    });
  
  
    // CAP/RETRO
    const btnInicioCR = document.querySelector('tr[data-inicial="CR"] .btn-inicio');
    const btnPausaCR = document.querySelector('tr[data-inicial="CR"] .btn-pausa');
    const statusCR = document.getElementById("CR-status");
    const timerCR = document.getElementById("CR-timer");
  
    btnInicioCR.addEventListener("click", () => {
      aplicarEstadoActividad("CR", btnInicioCR, statusCR, btnPausaCR)
    });
  
    btnPausaCR.addEventListener("click", () => {
      
    });
  
  
    // PAUSA
    const btnInicioP = document.querySelector('tr[data-inicial="P"] .btn-inicio');
    const btnPausaP = document.querySelector('tr[data-inicial="P"] .btn-pausa');
    const statusP = document.getElementById("P-status");
    const timerP = document.getElementById("P-timer");
  
    btnInicioP.addEventListener("click", () => {
      // Tu lógica para iniciar la actividad "PAUSA"
    });
  
    btnPausaP.addEventListener("click", () => {
      // Tu lógica para pausar la actividad "PAUSA"
    });
